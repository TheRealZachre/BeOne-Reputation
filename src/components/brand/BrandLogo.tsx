...
export function BrandLogo({
  ...
  vcfHref,
  beoneHref = "/",
}: BrandLogoProps & { beoneHref?: string | null }) {
  ...
  if (variant === "full") {
    return (
      <div className="text-center">
        <BeOneLogoMark variant="full" href={beoneHref ?? undefined} />
        {showTagline && (
  ...
  return (
    <div className="min-w-0">
      <BeOneLogoMark variant="sidebar" href={beoneHref ?? undefined} />
      {showTagline && (
